...
class CreateOrdenCompraEvaluacionProveedorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('orden_compra_evaluacion_proveedors', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('orden_compra_evaluacion_proveedors');
    }
}
