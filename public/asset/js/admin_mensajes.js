...
function mensajes(estado){
    ...
    let ruta = route('admin.mensajes_data',{id: estado});
...
function destacar(mensajes){
    $.ajax({
        ...
        url : route('admin.mensaje_destacar'),
        type: 'POST',
        data: {ids : mensajes},
        dataType: 'json',
...
function archivar(mensajes) {
    $.ajax({
        ...
        url : route('admin.mensaje_archivar'),
        type: 'POST',
        data: {ids : mensajes},
        dataType: 'json',
        success: function(respuesta) {
...
function eliminar(mensajes){
    $.ajax({
        ...
        url : route('admin.mensaje_eliminar'),
        type: 'POST',
        data: {ids : mensajes},
        dataType: 'json',
        success: function(respuesta) {
...
function responderModal(id){
    $.ajax({
        ...
        url : route('admin.mensaje_responder_modal',{'id': id}),
        dataType: 'html',
...
function respuestaSave(){
    ...
    $.ajax({
        ...
        url : route('admin.mensaje_responder_save'),
        type: 'POST',
