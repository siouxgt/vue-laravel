@extends('layouts.urg')
	...
	@section('content')
		...
		<p class="text-2 px-4">En esta página encontrarás los contratos de compras realizadas dentro de Contrato Marco.</p>
	...
	@endsection
	@section('js')
		@routes('contratoOcUrg')
		<script src="{{ asset('asset/js/contrato_oc_urg.js') }}" type="text/javascript"></script>
	@endsection