@extends('layouts.urg')
    @section('content')
        <div class="row">
            <div class="nav nav-tabs mt-5" id="nav-tab" role="tablist">
                <a href="{{ route('orden_compra.index')}}" class="text-gold ml-5"><i class="fa-solid fa-arrow-left text-gold ml-1"></i> Regresar</a>
            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="row  d-flex justify-content-center">
                    <div class="col-sm-12 col-md-4 text-center mt-3">
                        <p class="text-10">ORDEN DE COMPRA: {{ $ordenCompra->orden_compra }}</p>
    ...
    @endsection
    @section('js')
        @routes(['ordenCompra','tiendaUrg','ordenCompraUrg'])
        <script src="{{ asset('asset/js/orden_compra_show_urg.js') }}" type="text/javascript"></script>
    @endsection