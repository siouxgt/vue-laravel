        ...
        <section class="row justify-content-md-center">
            <div class="col-md-5 col-sm-11 align-self-center border rounded">
                    ...
                    <div class="col text-center">
                        ...
                        <div class="row mt-4">
                            <div class="col-12 d-flex justify-content-center">
                                <button type="button" class="btn boton-3a  float-left ml-3" @if($prorroga[0]->estatus == 0) onclick="responderProrrogaModal('{{ $prorroga[0]->id_e }}')" @else disabled @endif id="responder">Responder prorroga</button>
                            </div>
                        </div>
                        ...
                        @if($prorroga[0]->estatus != 0 && $prorroga[0]->acuse == null)
                            <div id="acuse">
                                <button type="button" class="btn boton-3a mt-3 mb-3" onclick="subirAcuseModal('{{ $prorroga[0]->id_e }}')" >Subir acuse</button>
                            </div>
                        @endif
                    </div>
                    <hr>
                ...
                <div class="col text-center">
                    ...
                    <button type="button" class="btn boton-3a mt-3 mb-3" @if($diasDiferencia < 0 && count($reportes) < 3) onclick="reportarModal('envio')" @else disabled @endif>Reportar</button>
                    <div id="des_reporte">
                    ...
                    <button type="button" class="btn boton-3a mt-3 mb-3" id="incidencia"  @if(count($reportes) == 3 && count($incidencias) < 1 ) onclick="incidenciaModal('envio')" @else disabled @endif>Abrir incidencia</button>
                ...
                <div class="col text-center">
                    <p class="text-1  m-2">Si el pedido no llegó en la fecha acordada y esperar no es opción, puedes cancelar la compra.</p>
                    <p class="text-14 mt-3">¿Quieres cancelar la compra?</p>
                   <button type="button" id="cancelar" class="btn boton-3a mt-3 mb-3" @if($envio->fecha_envio) disabled @else onclick="cancelar('envio')" @endif >Cancelar compra</button>
                </div>
