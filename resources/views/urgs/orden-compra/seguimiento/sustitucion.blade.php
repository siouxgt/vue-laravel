        ...
        <section class="row justify-content-md-center">
            <div class="col-md-5 col-sm-11 align-self-center border rounded">
                ...
                <div class="col text-center">
                    <p class="text-14">1. ¿Aceptas el pedido?</p>
                    <div class="row mt-3 pz-5">
                        @if($envio->estatus == true || is_null($envio->estatus))
                            <div class="@if($envio->estatus == true) col-12 @else col-6 float-right @endif">
                                <button type="button" class="btn boton-3a" @if(is_null($envio->estatus)) onclick="aceptarEnvio('aceptar')" @endif id="boton_si">Sí</button>
                            </div>
                        @endif
                        @if($envio->estatus == false || is_null($envio->estatus))
                            <div class="@if($envio->estatus == false and is_null($envio->estatus)) col-6 float-left @else col-12 @endif">
                                <button type="button" class="btn boton-3a" @if(is_null($envio->estatus)) onclick="aceptarEnvio('rechazar')" @endif id="boton_no">No</button>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <p class="text-14 text-center">2. Confirma los datos de facturación</p>
                ...
                @if($sustitucion != "[]")
                    <div class="col px-3 mb-4">
                        <p class="text-1 text-center mt-3">Si el pedido llegó incompleto o con daños, indica qué productos serán sustituídos.</p>
                        <div class="text-center mt-3">
                            <button type="button" class="btn boton-3a" @if($sustitucion[0]->motivo == null) onclick="productosSustituirModal()" @else disabled @endif>Productos por sustituir</button>
                        </div>
                    ...
                    <div class="col text-center mb-3">
                        ...
                        @if($sustitucion[0]->archivo_nota_remision)
                            ...
                            <div class="col">
                                ...
                                <div class="row mt-3 pz-5">
                                    <div class="col-12">
                                        <button type="button" class="btn boton-3a" @if($sustitucion[0]->aceptado == 0) onclick="aceptarSustitucion()" @endif id="sustitucionSi">Sí</button>
                                    </div>
                                </div>
                            </div>
                            <hr>
                ...
                @if($sustitucion == "[]")
                    <div id="div_acuse" class="ocultar">
                        <div class="col px-3 mb-4">
                            <p class="text-1 text-center mt-3">Si el pedido llegó incompleto o con daños, indica qué productos serán sustituídos.</p>
                            <div class="text-center mt-3">
                                <button type="button" class="btn boton-3a" onclick="productosSustituirModal()" id="boton_acuse">Productos por sustituir</button>
                            </div>

                            <p class="text-rojo mt-4 text-center ocultar" id="numero_sustitucion"></p>

                            <a target="_blank" id="acuse"><p class="text-5 mt-4 text-center ocultar"><strong><span><i class="fa-solid fa-file-invoice text-5"></i></span> Acuse</strong></p></a>
                        </div>
                        <hr>
                        ...
                        <div class="col text-center mb-3">
                            ...
                            <p class="text-1 mt-3"><strong>Días para entregar la sustitución</strong></p>
                            <p class="text-red-precio mt-1"><strong id="dias"></strong></p>
