                ...
                <table class="table" id="table_reporte">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">ID DE PRORROGA</th>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">MOTIVO DE LA SOLICITUD</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">FECHA DE SOLICITUD DE PRÓRROGA</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">JUSTIFICACIÓN DE LA SOLICITUD</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">DÍAS DE LA SOLICITUD DE PRÓRROGA</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($data as $key => $value)
                            <tr>
                                ...
                                <td class="tab-cent text-2">{{ $value->id_prorroga }}</td>
                                ...
                                <td class="tab-cent text-2">{{ $value->fecha_solicitud }}</td>
                                <td class="tab-cent text-2">{{ $value->justificacion }}</td>
                                <td class="tab-cent text-2">{{ $value->dias_solicitados }}</td>
                            </tr>
                        @endforeach 
                    </tbody>
                </table>
