@extends('layouts.urg')
            ...
            <div class="row">
                 <div class="col-md-4 col-sm-12">
                    <select class="custom-select my-1 mr-sm-2" id="reporte" name="reporte" required>
                        ...
                        <option data="3" value="2">REPORTE DE ADHESIÓN PROVEEDOR</option>
                        <option data="1" value="3">REPORTE DE ADHESIÓN URG</option>
                        <option data="1" value="4">REPORTE DE CATALOGO DE PRODUCTOS</option>
                        <option data="2" value="5">REPORTE DE INCIDENCIAS POR PROVEEDOR</option>
                        <option data="3" value="6">REPORTE DE ORDEN DE COMPRA COMPLETO</option>
                        <option data="2" value="7">REPORTE DE ORDEN DE COMPRA COMPLETO POR PROVEEDOR</option>
                        <option data="2" value="8">REPORTE DE ORDEN DE COMPRA GENERAL</option>
                        <option data="3" value="9">REPORTE DE PRECIOS CLAVES CABMS POR CONTRATO MARCO</option>
                        <option data="3" value="10">REPORTE DE PRODUCTOS POR CONTRATO MARCO COMPLETO</option>
                        <option data="2" value="11">REPORTE DE SOLICITUD DE PRORROGA PROVEEDOR</option>
                    </select>
                </div>
                <div class="col-md-4 col-sm-12">
    ...
    @section('js')
        @routes(['reporteUrg'])
        <script src="{{ asset('asset/js/reporte_urg.js') }}" type="text/javascript"></script>
    @endsection
