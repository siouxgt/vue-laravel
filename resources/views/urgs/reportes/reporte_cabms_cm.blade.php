                ...
                <table class="table" id="table_reporte">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">CABMS CDMX</th>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">PRECIO</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">PROVEEDOR</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">FECHA DE PUBLICACION</th>
                        </tr>
                    </thead>
                    <tbody>
