@extends('layouts.urg')
    @section('content')
        ...
        <div class="row float-right mt-3">
            <div class="col-6 col-md-6">
                <a href="{{ route('tienda_urg.ver_tienda')}}" id="btn_seguir_comprando" class="btn btn-white boton-7 border">
                    <span id="text-seguir">Seguir comprando</span>
                </a>
            </div>
            <div class="col-6 col-md-6">
    ...
    @section('js')
        <script>
            ...
            let regresar = document.querySelector('#btn_seguir_comprando');
            let texto = document.querySelector('#text-seguir');
            console.log(anterior[anterior.length -1])
            if(anterior[anterior.length -1] == 'orden_compra'){
                regresar.setAttribute("href","javascript: void(0);");
                regresar.setAttribute("onclick",'history.back();');
                texto.innerHTML = 'Regresar';
            }
        </script>
    @endsection
