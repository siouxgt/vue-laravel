                ...
                <table class="table" id="table_reporte">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">URG</th>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">CLAVE DE LA URG</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">FECHA DE LA INCIDENCIA</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">TIPO DE LLAMADA DE ATRNCIÓN</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">USUARIO QUIEN GENERA LA INCIDENCIA</th>
                        </tr>
                    </thead>
                    <tbody>
