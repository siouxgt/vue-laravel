                ...
                <table class="table" id="table_reporte">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">MONTO TOTAL DE LA ORDEN DE COMPRA</th>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">FECHA DE ORDEN DE COMPRA</th>
                        </tr>
                    </thead>
                    <tbody>
