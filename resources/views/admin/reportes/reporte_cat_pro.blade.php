                ...
                <table class="table" id="table_reporte">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">CLAVE CAMBS CDMX</th>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">VALIDACIÓN ADMINISTRATIVA</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">CONTRATO MARCO(NOMBRE)</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">ID CONTRATO MARCO</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">TOTAL PRODUCTOS POR CATALOGO</th>
                    ...
                    <tbody>
                        @foreach($data as $key => $value)
                            <tr>
                                ...
                                <td class="tab-cent text-2">{{ $value->productos }}</td>
