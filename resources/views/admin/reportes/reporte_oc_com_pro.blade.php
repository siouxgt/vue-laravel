                ...
                <table class="table" id="table_reporte">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th scope="col" class="tab-cent text-2 font-weight-bold">FECHA DE CREACIÓN DE LA ORDEN DE COMPRA</th>
                            <th scope="col" class="tab-cent text-2 font-weight-bold">REPRESENTANTE LEGAL</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($data as $key => $value)
                            <tr>
                                ...
                                <td class="tab-cent text-2">{{ $value->nombre_legal }} {{ $value->primer_apellido_legal }} {{ $value->segundo_apellido_legal }}</td>
                            </tr>
                        @endforeach 
                    </tbody>
                </table>
