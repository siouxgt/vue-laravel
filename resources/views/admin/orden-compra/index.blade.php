@extends('layouts.admin')
    ...
    @section('content')
        <div class="hr">
            <h1 class="m-2 guinda">Órdenes de compra</h1>
        <p class="fs-6 gris1 px-2">En esta página encontrarás las compras que has realizado en Contrato Marco. Para ver el detalle de tu compra, da clic en el icono de la columna “Ver más”.</p>
      </div>
    ...
    <div class="row elemtos">
            <div class="col-12 col-lg-2 col-md-2 col-sm-8 text-center offset-md-5">
        <p class="boton-11 rounded mt-1 mb-1 p-1">Total Órdenes de compra:<span class="text-9 font-weight-bold ml-1">{{ $totalOC }}</span></p>
            </div>
        </div>
            ...
            <table class="table my-5 justify-content-md-center" id="table_orden_compra">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="tab-cent text-1 font-weight-bold">URG</th>
    ...
    @section('js')
        ...
        <script src="{{ asset('asset/js/orden_compra_admin.js') }}" type="text/javascript"></script>
    @endsection