@extends('layouts.admin')
    @section('content')
        ...
        @include('admin.orden-compra.encabezado')
        ...
        <section class="row justify-content-md-center">
            <div class="col-md-5 col-sm-11 align-self-center border rounded">
                ...
                <div class="row p-2 mz-5 ml-1">
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-end">
                            <a class="btn {{ json_decode($ordenCompraEstatus->confirmacion_boton_urg)->css }} ajustar-btn-seguimiento" href="{{ route('orden_compra_admin.confirmacion') }}">{{ json_decode($ordenCompraEstatus->confirmacion_boton_urg)->mensaje }}</a>
                        </div>
                    </div>
                </div>
                <hr>
                <div class="row p-2 ml-1">
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-end">
                            <a class="btn {{ json_decode($ordenCompraEstatus->contrato_boton_urg)->css }} ajustar-btn-seguimiento" @if($ordenCompraEstatus->contrato) href="{{ route('orden_compra_admin.contrato') }}" @endif>{{ json_decode($ordenCompraEstatus->contrato_boton_urg)->mensaje }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row p-2 ml-1">
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-end">
                             <a class="btn {{ json_decode($ordenCompraEstatus->envio_boton_urg)->css }} ajustar-btn-seguimiento" @if($ordenCompraEstatus->envio) href="{{ route('orden_compra_admin.envio') }}" @endif>{{ json_decode($ordenCompraEstatus->envio_boton_urg)->mensaje }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row p-2 ml-1">
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-end">
                            <a class="btn {{ json_decode($ordenCompraEstatus->entrega_boton_urg)->css }} ajustar-btn-seguimiento" @if($ordenCompraEstatus->entrega) href="{{ route('orden_compra_admin.sustitucion') }}" @endif>{{ json_decode($ordenCompraEstatus->entrega_boton_urg)->mensaje }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row p-2 ml-1">
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-end">
                            <a class="btn {{ json_decode($ordenCompraEstatus->facturacion_boton_urg)->css }} border ajustar-btn-seguimiento" @if($ordenCompraEstatus->facturacion) href="{{ route('orden_compra_admin.facturacion') }}" @endif>{{ json_decode($ordenCompraEstatus->facturacion_boton_urg)->mensaje }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row p-2 ml-1">
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-end">
                             <a class="btn {{ json_decode($ordenCompraEstatus->pago_boton_urg)->css }} border ajustar-btn-seguimiento" @if($ordenCompraEstatus->pago) href="{{ route('orden_compra_admin.pago') }}" @endif>{{ json_decode($ordenCompraEstatus->pago_boton_urg)->mensaje }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row p-2 ml-1">
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-end">
                            <a class="btn {{ json_decode($ordenCompraEstatus->evaluacion_boton_urg)->css }} border ajustar-btn-seguimiento" @if($ordenCompraEstatus->evaluacion) href="{{ route('orden_compra_admin.evaluacion') }}" @endif>{{ json_decode($ordenCompraEstatus->evaluacion_boton_urg)->mensaje }}</a>
                        </div>
                    </div>
                </div>
