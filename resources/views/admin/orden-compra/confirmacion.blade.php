        ...
        <section class="row justify-content-md-center">
            <div class="col-md-5 col-sm-11 align-self-center border rounded">
                ...
                <div class="text-center mt-2">
                     <p class="text-gold">
                        <a @if($contProductoAceptados) href="{{ route('orden_compra_admin.acuse_producto_confirmada', ['proveedor' => session()->get('proveedorId')]) }}" class="text-gold-titulo" @else class="text-gris-titulo" @endif><i class="fa-solid fa-file-invoice @if($contProductoAceptados)  gold @else gris @endif"></i>Acuse</a>
                    </p>
                </div>    
                <hr>
                <div class="text-center">
                ...
                <div class="text-center mt-1">
                    <p class="text-14">Orden cancelada</p>
                </div> 
