    ...
    <div class="container">
        ...
        <div class="tab-content border" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <hr>
                <form id="frm_expediente_cm" enctype="multipart/form-data">
                    <div class="form-group mt-3">
                        <div class="row mx-3 solo">
                            ...
                            <div class="row col-sm-6 mt-4 mz-2 text-1">
                                <div class="form-group">
        ...
        @switch( $expediente->metodo )
            @case('Convocatoria Pública Contrato Marco')
                @include('admin.licitacion-publica.create')
            @break
            @case('Convocatoria Restringida Contrato Marco')
                @include('admin.invitacion-restringida.create')
            @break
            @case('Convocatoria Directa Contrato Marco')
                @include('admin.adjudicacion-directa.create')
            @break
        @endswitch
    </div>
    <hr>
