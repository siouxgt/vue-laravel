	...
	@section('content')
		  <div class="row">
		      <p class="mt-3 ml-5 mb-4 d-flex align-items-center">
		          <a href="{{ route('producto_admin.show', ['id' => $producto->id_e] ) }}" class="gold-3"><i class="fa-solid fa-arrow-left gold"></i>Regresar</a>
		        </p>
		  </div>
		  ...
		  <div class="text-1">
		      ...
		      <nav aria-label="breadcrumb">
		          <ol class="breadcrumb text-2">
		              ...
		              <li class="breadcrumb-item"><a href="{{ route('producto_admin.index') }}">Producto</a></li>
		              <li class="breadcrumb-item"><a href="{{ route('producto_admin.show', ['id' => $producto->id_e] ) }}">{{ $producto->nombre_producto}}</a></li>
