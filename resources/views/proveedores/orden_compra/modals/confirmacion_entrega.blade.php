<div class="modal fade" id="modal_confirmacion_entrega" data-backdrop="static" data-keyboard="false" role="dialog"
    aria-labelledby="modal_confirmacion_entregaLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header badge-light">
                <h5 class="modal-title" id="modal_confirmacion_entregaLabel">
            ...
            <form id="frm_confirmacion_entrega">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button class="btn boton-12" type="button" id="btn_guardar_confirmacion_entrega">Guardar</button>
                </div>
            </form>
        </div>
    </div>
