...
<div class="contenedor-general">
    <div class="caja-formulario">
        ...
        <div class="datosNoEditables" id="principio">
    ...
    <div class="caja-formulario">
        ...
        <div class="formulario-contactos">
            ...
            <form id="frm_m_escalamiento">
                @csrf
                <input type="hidden" id="celda" value="0">
                <div>
                    ...
                    <div class="row first-row">
                        <div class="wrap">
                            <div>
                                <input class="name text-uppercase" type="text" name="nombre_tres" id="nombre_3" required="required" autocomplete="off" value="{{old('nombre_tres')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="fname text-uppercase" type="text" name="primer_apellido_tres" id="primer_apellido_3" required="required" autocomplete="off" value="{{old('primer_apellido_tres')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="lname text-uppercase" type="text" name="segundo_apellido_tres" id="segundo_apellido_3" required="required" autocomplete="off" value="{{old('segundo_apellido_tres')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="cargo text-uppercase" type="text" name="cargo_tres" id="cargo_3" required="required" autocomplete="off" value="{{old('cargo_tres')}}" />
                    ...
                    <div class="row first-row">
                        <div class="wrap">
                            <div>
                                <input class="num_oficina" type="text" name="telefono_3" id="telefono_3" required="required" autocomplete="off" value="{{old('telefono_3')}}" title="Proporciona un número telefonico." />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="extension" type="text" name="extension_3" id="extension_3" required="required" autocomplete="off" value="{{old('extension_3')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="num_celular" type="text" name="celular_3" id="celular_3" required="required" autocomplete="off" value="{{old('celular_3')}}" title="Proporciona un número de celular." />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="email text-lowercase" type="text" name="correo_tres" id="correo_3" required="required" autocomplete="off" value="{{old('correo_tres')}}" />
                    ...
                    <div class="row first-row">
                        <div class="wrap">
                            <div>
                                <input class="name text-uppercase" type="text" name="nombre_dos" id="nombre_2" required="required" autocomplete="off" value="{{old('nombre_dos')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="fname text-uppercase" type="text" name="primer_apellido_dos" id="primer_apellido_2" required="required" autocomplete="off" value="{{old('primer_apellido_dos')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="lname text-uppercase" type="text" name="segundo_apellido_dos" id="segundo_apellido_2" required="required" autocomplete="off" value="{{old('segundo_apellido_dos')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="cargo text-uppercase" type="text" name="cargo_dos" id="cargo_2" required="required" autocomplete="off" value="{{old('cargo_dos')}}" />
                    ...
                    <div class="row first-row">
                        <div class="wrap">
                            <div>
                                <input class="num_oficina" type="text" name="telefono_2" id="telefono_2" required="required" autocomplete="off" value="{{old('telefono_2')}}" title="Proporciona un número telefonico." />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="extension" type="text" name="extension_2" id="extension_2" required="required" autocomplete="off" value="{{old('extension_2')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="num_celular" type="text" name="celular_2" id="celular_2" required="required" autocomplete="off" value="{{old('celular_2')}}" title="Proporciona un número de celular." />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="email text-lowercase" type="text" name="correo_dos" id="correo_2" required="required" autocomplete="off" value="{{old('correo_dos')}}" />
                    ...
                    <div class="row first-row">
                        <div class="wrap">
                            <div>
                                <input class="name text-uppercase" type="text" name="nombre_uno" id="nombre_1" required="required" autocomplete="off" value="{{old('nombre_uno')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="fname text-uppercase" type="text" name="primer_apellido_uno" id="primer_apellido_1" required="required" autocomplete="off" value="{{old('primer_apellido_uno')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="lname text-uppercase" type="text" name="segundo_apellido_uno" id="segundo_apellido_1" required="required" autocomplete="off" value="{{old('segundo_apellido_uno')}}" />
                                <label for="segundo_apellido_uno">Segundo apellido</label>
                            </div>
                        ...
                        <div class="wrap">
                            <div>
                                <input class="cargo text-uppercase" type="text" name="cargo_uno" id="cargo_1" required="required" autocomplete="off" value="{{old('cargo_uno')}}" />
                                <label for="cargo_uno">Cargo<span class="asterisco_obligatorio">*</span></label>
                            </div>
                    ...
                    <div class="row first-row">
                        <div class="wrap">
                            <div>
                                <input class="num_oficina" type="text" name="telefono_1" id="telefono_1" required="required" autocomplete="off" value="{{old('telefono_1')}}" title="Proporciona un número telefonico." />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="extension" type="text" name="extension_1" id="extension_1" required="required" autocomplete="off" value="{{old('extension_1')}}" />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="num_celular" type="text" name="celular_1" id="celular_1" required="required" autocomplete="off" value="{{old('celular_1')}}" title="Proporciona un número de celular." />
                        ...
                        <div class="wrap">
                            <div>
                                <input class="email text-lowercase" type="text" name="correo_uno" id="correo_1" required="required" autocomplete="off" value="{{old('correo_uno')}}" />
                ...
                <button class="button-dorado derecha" type="submit" id="btnOcular">Guardar y continuar</button>
            </form>
        </div>
    </div>
    <!--  -->
    <div class="footer-formulario-pagina">
        <form>
            ...
            @endif
            <button class="button-dorado derecha" type="button" id="btnGuardarME">Guardar y continuar</button>
        </form>
    </div>
