    ...
    @section('content')
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                <h4 class="-2 guinda">Contratos Marco</h4>
                <div class="row migajaPan">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb"> 
                            <li class="breadcrumb-item"><a href="{{ route('proveedor.aip') }}">Inicio</a></li>
                            <li class="breadcrumb-item active"><a href="{{ route('contrato_proveedor.index_proveedor') }}">Contratos Marco</a></li>
                        </ol>
                    </nav>
                </div>    
            </div>
                    ...
                    @foreach($contratosHabilitados as $habilitados)
                        <article class="col-12 col-md-4 mt-3">
                            <div class="sombra p-1">
                                ...
                                <a href="{{ route('contrato_proveedor.show_proveedor', ['contrato' => $habilitados->id_e]) }}">
                    ...
                    @foreach($contratosNoHabilitados as $noHabilitados)
                        <article class="col-12 col-md-4 mt-3">
                            <div class="sombra p-1">
                                ...
                                <a href="{{ route('contrato_proveedor.show_proveedor', ['contrato' => $noHabilitados->id_e]) }}">
                                    <div class="row justify-content-center">
                                        <div>
                    ...
                    @foreach($contratosNoParticipa as $noParticipa)
                        <article class="col-12 col-md-4 mt-3">
                            <div class="sombra p-1">
                                ...
                                <a href="{{ route('contrato_proveedor.show_proveedor', ['contrato' => $noParticipa->id_e]) }}">
                                    <div class="row justify-content-center">
                                        <div>
