            ...
            <div class="col-12 col-lg-6">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb"> 
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('contrato_proveedor.index_proveedor') }}">Contratos Marco</a></li>
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    ...
                    <div class="form-row mx-3">
                        ...
                        <div class="form-group col-12 col-lg-12 col-md-6 mt-3 text-1">
                            @php
                            $sectoresEspecificos = ['general' => 'General', 'mipymes' => 'MIPYMES', 'campesinos' => 'Campesinos', 'cooperativas' => 'Cooperativas', 'elpm' => 'Empresas lideradas por mujeres', 'sr' => 'Grupos rurales', 'proa' => 'Productor agricola'];
                            //Indice
                            @endphp
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel">
                    ...
                    <div class="container">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover jtable_center nowrap" style="width:100%" id="tabla_anexos_contrato">
