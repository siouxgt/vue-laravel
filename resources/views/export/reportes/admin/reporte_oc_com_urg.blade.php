<table>
	<thead>
		...
		<tr>
			<th colspan="19" align="center">REPORTE DE ORDEN DE COMPRA COMPLETO POR URG</th>
		</tr>
		<tr>
		...
		<tr>
            ...
            <th style="background-color: #235b4e; color: #ffffff; width:100px;">ID DE CONTRATO MARCO</th>
            <th style="background-color: #235b4e; color: #ffffff; width:100px;">NOMBRE CONTRATO MARCO</th>
            <th style="background-color: #235b4e; color: #ffffff; width:100px;">FECHA DE CREACIÓN DE ORDEN DE COMPRA</th>
            <th style="background-color: #235b4e; color: #ffffff; width:100px;">DIRECTOR GENERAL DE ADMINISTRACIÓN U HOMÓLOGO</th>
            <th style="background-color: #235b4e; color: #ffffff; width:100px;">RESPONSABLE DE GENERAR LA ORDEN DE COMPRA</th>
		</tr>
	</thead>
	<tbody>
		@php 
		...
		<tr>
            ...
            @php 
            	...
            	$totalOc = $key + 1;
            	$totalProveedores[$key] = $value->rfc;
            @endphp
		</tr>
		@endforeach
	</tbody>
