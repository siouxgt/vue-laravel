...
<body>
	...
	<header class="top p-4">
        <div class="row align-items-center m-1">
			<div class="logos col-sm-12 col-md-5 justify-content-start">
                <img class="cdmx" src="{{ asset('asset/img/logoSAFtianguis.png') }}" alt="Logo" />
            </div>
            <div class="col-sm-12 col-md-7">
                <div class="d-flex flex-row-reverse bd-highlight align-items-center iconos ">
                        ...
                        <div class="col-sm-2 Hd-alerta text-center">
                                <span>
                        ...
                        <div class="col-sm-8 d-flex justify-content-end iconos">
                            <div class="d-flex align-items-center Hd-buscar">
                                <span>
                                    <form>
                                        <input type="input" class="form__field" placeholder="ID o Contrato" name="name"
                                            id="search" required />
                                    </form>
    ...
    {{-- <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse align-items-center" id="navbarSupportedContent">
                <div class="nav nav-item"><a href="{{ route('index') }}"
                        class="{{ Route::is('index') ? 'nav-active' : 'underline' }}">Inicio</a>
                </div>
                <div class="nav nav-item dropdown">
                    <a href="javascript: void(0)"
                    class="{{ Route::is(['cat_proveedor.*', 'cat_producto.*', 'urg.*', 'validacion.*']) ? 'nav-active' : 'underline' }}">Catálogos
                ...
                <div class="nav nav-item mt-2"><a href="{{ url('contrato') }}"
                        ...
                        Marco</a></div>
                <div class="nav nav-item mt-2"><a href="{{ route('orden_compra_admin.index') }}"
                        class="{{ Route::is('orden_compra_admin.*') ? 'nav-active' : 'underline' }}">Órdenes de
                        Compra</a></div>
                <div class="nav nav-item mt-2"><a href="javascript: void(0)" class="underline">Permisos</a></div>
                <div class="nav nav-item dropdown">
                    <a href="javascript: void(0)" class="underline">Subasta<i class="fa fa-angle-down gris"
                ...
                <div class="nav nav-item dropdown">
                    <a href="javascript: void(0)" class="underline">Reportes<i class="fa fa-angle-down gris"
                            aria-hidden="true"></i></a>
                    <div class="dropdown-content">
                        <li class="dropdown">
                            <a href="javascript: void(0)" class="dropdown">Histórico de precios
                                <div style="float: right"><i class="fa fa-angle-right" aria-hidden="true"></i>
                                </div>
                            </a>
                        </li>
                        <li class="dropdown nav-item">
                            <a href="javascript: void(0)" class="dropdown">Reportes
                                <div style="float: right"><i class="fa fa-angle-right" aria-hidden="true"></i>
                                </div>
                            </a>
                        </li>
                ...
                <div class="nav nav-item dropdown">
                    <a href="javascript: void(0)" class="underline">Mensajes <i class="fa fa-angle-down gris"
                            aria-hidden="true"></i></a>
                    <div class="dropdown-content">
                    </div>
                </div>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse align-items-center" id="navbarSupportedContent">
                <ul class="navbar-nav ">
                    <div class="nav nav-item mt-2"><a href="{{ route('index') }}"
                            class="{{ Route::is('index') ? 'nav-active' : 'underline' }}">Inicio</a>
                    </div>
                    <div class="nav nav-item dropdown">
                        <a href="javascript: void(0)"
                    ...
                    <div class="nav nav-item mt-3"><a href="javascript: void(0)" class="underline">Permisos</a></div>
                    <div class="nav nav-item dropdown">
                    ...
                    <div class="nav nav-item dropdown">
                        <a href="javascript: void(0)" class="underline" role="button" data-bs-toggle="dropdown" aria-expanded="false">Reportes<i class="fa fa-angle-down gris"
                                aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-content">
                            <li class="dropdown nav-item">
